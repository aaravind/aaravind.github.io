  ...
  //document.getElementById('map_legend'));
          $(function() {
    $('#map_legend').html('<div class="header">Toscana,Jayanagar</div><div class="image_slide_content"></div><div class="detail_container"></div>');
  ...
  +'<defs>'
  +'<style> .cls-1 {fill: #da2043;stroke: #fff;stroke-linejoin: round;stroke-opacity: 0.79;stroke-width: 7px;fill-rule: evenodd;filter: url(#filter);}'
    ...
    +'<filter id="filter" x="1007" y="406" width="91" height="100" filterUnits="userSpaceOnUse">'
     ...
     +'<feFlood result="flood-2" flood-color="#6d4d8c"/>' 
     +'<feComposite result="composite-2" operator="in" in2="SourceGraphic"/>'
     +'<feBlend result="blend-2" in2="blend"/>'
     +'</filter>'
   +'</defs>'
  +'<g transform="translate(-1003.5 -402.5)" style="fill: #da2043; filter: url(#filter)">'
...
+'</svg>';
        ...
        marker = new google.maps.Marker({
            ...
            icon: { url: 'data:image/svg+xml;charset=UTF-8;base64,' + btoa(svg_container(marker_object[i].id)) } 
        });
